...
var (
	...
	//type "getmac" in cmd to get the device name and id
	device       string = "\\Device\\NPF_{8C127BFB-5736-48D6-B441-21449F7171A5}"
...
func main() {
	// Sending device info to interface
...
func processPacket(packet gopacket.Packet) {
	...
	if applicationLayer != nil {
		...
		Request.Data.Payload = string(applicationLayer.Payload())
	...
	// read response body if you want to debug or log it
	...
	// Check for packet decode errors
